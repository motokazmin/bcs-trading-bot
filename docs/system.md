...
**Цель:** автоматизированный агент для **внутридневной торговли акциями** MOEX (класс **TQBR**, API БКС). Исследования и FROZEN portfolio — ORC, OR Fade, MF Afternoon; депозит 200k, сессия 10:00–18:40 MSK, M5.
...
4. **Сессия:** 10:00–18:40 MSK; EOD — `session.eod_close_time` (**18:40** у portfolio).
...
Код: `internal/engine/worker.go`, `internal/simulation/portfolio.go`, `internal/trailing/`.
